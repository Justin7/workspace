...
public class MainActivity extends Activity implements TitlesFragment.OnItemSelectedListener {
    ...
    private String[] mToggleLabels = {"Show", "Hide"};
    private static final int NOTIFICATION_DEFAULT = 1;
    private static final String ACTION_DIALOG = "my.andr.hcgallery.action.DIALOG";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ActionBar bar = ____________();
        if(mDualFragments) bar.setDisplayShowTitleEnabled(false);
